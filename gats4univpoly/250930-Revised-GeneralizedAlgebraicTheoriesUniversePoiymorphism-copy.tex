...
The operator symbols are obtained by internalizing the corresponding rules for the externally indexed universes. As before, we only show closure under $\Pi$. (We leave out the common premise $n : \lctx$).
\begin{eqnarray*}
