...
\end{eqnarray*}
we leave the framework of generalized algebraic theories, since they do not allow equations in contexts. In the next section we will show how to extend our calculus with such external constraints.
