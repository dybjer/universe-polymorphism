...
Then we have the semi-lattice equations for $l \vee l'$\footnote{%
MB Let's introduce up-front a good convention for leaving out the type
of an equation and the meta-context with all the variable declarations.
Critical cases are the equations for equality reflection,
since they have the declaration of a variable that does neither occur
in the equation, nor in the type. This is a prototype example of
...
Proof $\Rightarrow$: By induction on the proof of $l <_i m$. All cases are direct.
