...
What does this correspond to in the present setting? Consider the initial model of the present gat, see for example our paper on gats and cwfs \cite{bezem:hofmann}. If we let 
