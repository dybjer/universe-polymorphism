...
\begin{eqnarray*}
\Gamma : \ctx, A : \ty(\Gamma), a, a' : \tm(\Gamma, A),p :  \tm(\Gamma,\leq(a,a'))&\vdash& a = a' : \tm(\Gamma,A)\\
n : \lctx, l, l' : \ltm_n, p : \ctm_n(\leq(l,l')) &\vdash& l = l' : \ltm_n
\end{eqnarray*}
Hence the sort symbols for constraint term (proof)
\begin{eqnarray*}
n : \lctx &\vdash& \cctx_n\\
n : \lctx, \psi : \cctx_n&\vdash& \chom_n(\psi)\\
n : \lctx &\vdash& \cty_n\\
n : \lctx, c : \cty_n &\vdash& \ctm_n(c)
\end{eqnarray*}
}

\begin{eqnarray*}
n : \lctx, l, l' : \ltm_n &\vdash& \leq(l,l') : \cty_n\\
n : \lctx, l, l' : \ltm_n, \psi : \cctx_n, p : \ctm_n(\psi,\leq(l,l')) &\vdash& l = l' : \ltm_n
\end{eqnarray*}
...
A constraint "term" $p : \ctm_n(\psi,c)$ is a proof that the equations 
in $\psi$ imply the equation $c$, see \cref{exa:cctx-entails-lattice-eqs}
...
A constraint morphism $ps : \chom_n(\psi,\psi')$ is a proof that the 
constraints in $\psi$ imply the constraints in $\psi'$, 
and represents that the judgment $$\psi \vdash \psi'$$ holds in our paper.% 
\footnote{MB: unclear. Where do we have such judgments?}
