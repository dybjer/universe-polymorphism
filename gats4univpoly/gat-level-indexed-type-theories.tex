...
\subsection{A level-indexed tower of universes}
...
We need to ensure that any universe $\UU_l$ has a code $\UU^m_l$ in any larger universe $\UU^l$ for $l < m$, where the latter is defined as $l^+ \vee m = m$, as in the externally indexed universes. We would like to  type of the operator symbol for such codes should be something like
\begin{eqnarray*}
