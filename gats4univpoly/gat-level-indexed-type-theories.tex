...
\begin{eqnarray*}
n : \lctx, l, l' m : \ltm(n) &\vdash& \leq_n(l,l')
\end{eqnarray*}
and an operator symbol for reflexivity:
\begin{eqnarray*}
n : \lctx, l, l' m : \ltm(n) &\vdash& \refl(l) :  \leq_n(l,l)
\end{eqnarray*}
...
\begin{eqnarray*}
n : \lctx, l, m : \ltm(n), p : l < m, \Gamma : \ctx&\vdash&(\UU^m_l)_\Gamma: \tm(\Gamma,(\UU_{m})_\Gamma)
\end{eqnarray*}
