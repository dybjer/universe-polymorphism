...
\paragraph{Indexed cwfs.} We then show generalized algebraic theories for explicit universe polymorphism. This is the theory of cwfs indexed by unityped cwfs (ucwfs) of universe levels. Let $\L$ be the base category of the ucwf of levels. A level-indexed cwf is a cwf-valued presheaf 
$$
T : \L^\op \to \CwF
$$
