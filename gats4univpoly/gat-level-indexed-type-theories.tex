...
A key ingredient in the gat $\Sigmaint$ is the sort symbol for level equality $\leq$. In a forthcoming article we plan to show how level equality sorts can be employed for representing equational constraints and present a gat for Martin-Löf type theory with level-indexed universes and equational constraints as presented in Section 5 in Bezem et al \cite{BezemCDE22}. 
