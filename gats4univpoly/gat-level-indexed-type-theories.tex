...
\Gamma : \ctx, a : \tm(\Gamma,(\U_{l})_\Gamma) &\vdash& {\Ta^m_{l}}(a) : \tm(\Gamma,(\U_{m})_\Gamma))
\end{eqnarray*}
However, the external assumption $l < m$ on levels cannot directly be internalized as the level equation $l^+ \vee m = m$ since gats do not admit equational constraints on its arguments. Instead we introduce three cumulativity maps
\begin{eqnarray*}
