...
\paragraph{Acknowledgement to Stefano Berardi.} This paper is a contribution to a Festschrift in honour of Professor Stefano Berardi, the University of Torino, on the occasion of his 60th birthday. Stefano is a valued friend and colleague who has made many deep contributions to type theory and constructivity, in particular to analyzing the constructiive content of classical logic.

\section{Type theory with an external tower of universes}

We refer to the appendix for the generalized algebraic theory of cwfs with $\Pi$-types, and a single universe $\UU$ closed under $\Pi$-types. We could of course add other type formers as well, and let $\UU$ be closed under those too, but leave this to the reader. 
...
In the cumulative case we have operator symbols that lift elements in the $l$th universe to the $m$th universe for $l < m$:
%\begin{tiny}
\begin{eqnarray*}
