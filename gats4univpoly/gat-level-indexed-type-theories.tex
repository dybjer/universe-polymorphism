...
However, if universe levels form a type we can quantify over them, something we wish to disallow. This is the main motivation for designing a type theory with universe level judgments rather than a type of levels.
