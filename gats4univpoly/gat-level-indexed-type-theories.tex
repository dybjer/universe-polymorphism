...
We have the following decoding equations for lifting:
\begin{eqnarray*}
l,l',m,m' : \ltm(n), l < m, l' < m' &\vdash& \Ta^{m \vee m'}_{l \vee l'}(\Pi^{l,l'}(a,b)) = \Pi^{m,m'}(\Ta^m_l(a),\Ta^{m'}_{l'}(b))\\
k, l, m : \ltm(n), k < l < m &\vdash& \Ta^m_l((\UU^l_k)_\Gamma) = (\UU^m_k)_\Gamma
\end{eqnarray*}
