...
\end{eqnarray*}
%\end{tiny}
\paragraph{Lawvere theories.} (* Remove *) Ucwfs are closely related to Lawvere theories. One can prove that the latter are equivalent to contextual ucwfs, that is, ucwfs where each context has a length \cite{castellan:lambek}.
