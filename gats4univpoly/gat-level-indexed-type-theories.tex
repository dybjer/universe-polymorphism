...
\begin{eqnarray*}
n : \lctx, \psi : \cctx_n,  l : \ltm_n &\vdash& [l]  : \ltmq_n(\psi)\\
n : \lctx, \psi : \cctx_n,  l, l' : \ltm_n, p : \ctm_n(\psi,\leq(l,l')) &\vdash& [l] = [l'] : \ltmq_n(\psi)
\end{eqnarray*}
Note that this is related to equality reflection: from a "propositional" level equality $\leq(l,l')$ we derive a judgmental level equality, and it is the latter that makes enables equational reasoning about $\vee$ and $(-)^+$ and $\psi$.
