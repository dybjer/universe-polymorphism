...
\end{eqnarray*}
This is to be understood as the quotient sort of $\ltm$ with respect to the equivalence relation generated by the constraints in $\psi$ and the laws for $\vee$ and $(-)^+$. We have a new operator symbol $[-]$ for equivalence class formation with its equation:
\begin{eqnarray*}
