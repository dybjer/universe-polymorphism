...
\end{quotation}
\todo[inline]{Perhaps italicize the direct quotations.}
...
\todo[inline]{Is this extension something done in this paper, or is this in the literature?}
...
\todo[inline]{The last sentence of the above paragraphs begs for a conclusion.}
...
In our paper we followed Courant's approach \cite{Courant02} to explicit universe polymorphism and\todo{The meaning of this ``and'' is ambiguous} introduced special universe level {\em judgments}:
$$
l\ \level
\hspace{5em}
l = l'
...
\todo[inline]{Add a reference for \url{https://hackage.haskell.org/package/Agda-2.6.4/changelog}.}
