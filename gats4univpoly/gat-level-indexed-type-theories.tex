...
In Bezem, Coquand, Dybjer, and Escard\'o \cite{bezem:hofmann} we defined the notion of a correct presentation $\Sigma$ of a gat and its category of models $\CwF_\Sigma$ of cwfs with a $\Sigma$-structure. We also constructed a term model $\T_\Sigma$ and proved that it is initial in $\CwF_\Sigma$.
