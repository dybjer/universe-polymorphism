...
\end{itemize}
We then need to define the operator symbols on equivalence classes. First there are the operator symbols that construct raw syntax. For example:
\begin{itemize}
...
\end{itemize}
Then we consider the operator symbols that correspond to implicit operations defined by induction. For example:
\begin{itemize}
