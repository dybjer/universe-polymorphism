...
theory.}
\end{quotation}
\todo[inline]{Here we could say: we pursue a variant of Voevodsky's approach: we will use gats rather than quasi-equational theories, and we will use cwfs rather than the C-systems (contextual categories). Gats and cwfs are intimately connected ... cwfs (and variants) are suitable for a uniform approach to deductive logical systems.}
...
We build this initial cwf with extra structure for the small type formers and a tower of universes as the following term model $\Text = (\Ctx,\Sub,\Ty,\Tm)$, we interpret the sort symbols in terms of the judgment forms of $\TText$ as follows:
\begin{itemize}
...
\begin{itemize}
\item Is there a generic construction of external cwf with extra structure? 
\item Is there a generic construction of cwfs with implicit substitutions for some class of gats? 
