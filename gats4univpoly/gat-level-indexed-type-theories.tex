...
with $n\equiv 2$, $l\equiv \beta\vee\alpha$, $l'\equiv \beta$ and $\psi:= \psiab$\footnote{check signs for instatiation and definition}
as above and get 
\[
p : \ctm_2(\psiab,\leq(\beta\vee\alpha,\beta))\vdash 
...
\[
p : \ctm_2(\psiab,\leq(\alpha,\alpha\vee\beta))\vdash 
