...
since there is only one substitution $1.\Mon \to 1$. (Here and in the following we have dropped the indices and written $\p$ instead of the official $\p_\Mon$, $\tuple{}$ instead of $\tuple{}_{1.\Mon}$ as prescribed by the grammar for raw expressions.)
\item[Adding the operator symbol for composition.]
