...
\author[P. Dybjer]
{P\ls I\ls E\ls R\ls R\ls E\ns C\ls L\ls A\ls I\ls R\ls A\ls M\ls B\ls A\ls U\ls L\ls T$^1$%
\thanks{}
\ns and\ns P\ls E\ls T\ls E\ls R\ns
D\ls Y\ls B\ls J\ls E\ls R$^2$\\
$^1$ CNRS, ENS de Lyon, Inria, UCBL, Universit\'e de Lyon, 
\addressbreak Laboratoire LIP, 46 All\'ee d'Italie, 69364 Lyon, France.
\addressbreak \texttt{pierre.clairambault@ens-lyon.fr}\\
