...
%{M\ls A\ls R\ls C\ns 
%B\ls E\ls Z\ls E\ls  M^1$%
%\thanks{}
%\ns 
%and
%\ns P\ls E\ls T\ls E\ls R\ns
%D\ls Y\ls B\ls J\ls E\ls R$^2$\\
%$^1$ , 
%Department of Informatics, University of Bergen.
%\addressbreak Laboratoire LIP, 46 All\'ee d'Italie, 69364 Lyon, France.
%\addressbreak \texttt{Marc.Bezem@uib.no}\\
%$^2$ Department of Computer Science and Engineering, 
%\addressbreak Chalmers University of Technology, S-412 96 G\"oteborg, Sweden.
%\addressbreak \texttt{peterd@chalmers.se}
%}
%
...
%Moreover, internal monoids, categories, and cwfs in the cwf~$\Set$ are small monoids, categories, and cwfs, respectively. Note that the ``external" cwfs defined in Section 2 need not be small, and hence not internal cwfs in the cwf~$\Set$.
...
\end{description}
We define the \FYI{presentation of} monoids to be $\Sigma = \Sigma_6$. The category $\Cwf_\Sigma$ is the category of small cwfs with an {\em internal monoid}. This is a cwf-version of the notion of internal monoid which can be defined in any category with finite products. 
...
%Similarly, if $\Sigma$ is the presentation of the generalized algebraic theory of cwfs, the objects of $\Cwf_\Sigma$ are $\V$-small cwfs with an internal monoid. Examples are the $\V$-small cwf of $\V'$-small sets with an internal monoid. Such an internal monoid is a monoid in the usual sense where the carrier is $\V'$-small.
