...
We analyse the complexity of various results in the following list.
...
takes in the worst case $f(x)$ steps to arrive at the model $f(y)=f(x)+1$.
...
is inflationary, leading to the predecessor axioms in $\upS{C}$. The first
