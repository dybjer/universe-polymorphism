...
{\color{red} By Lemma~\ref{lem:plusbodyS} and Lemma~\ref{lem:shift-up}
we see that $S^\uparrow_C\prvH A\to b$ is equivalent to
$S^{\uparrow+}_C + T \prvH V,A^+ \to b^+$. We note in passing
that $S^{\uparrow+}_C + T$ is in fact $S^{\uparrow}_{C^+}$, where
