...
new categories, and only categories introduced as such are types,
not \ttt{type} itself. 
One new type of category \ttt{type} is \ttt{bool}, 
...
By substitution one can form the type \ttt{TRUE(p)} for any proposition \ttt{p}. 
...
The possibility of functional abstraction with respect to \ttt{type} is
