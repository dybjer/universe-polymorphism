...
As already mentioned, Sozeau and Tabareau's \cite{SozeauTabareau:coq} work is closely related. The most important difference is between their ML-like polymorphim and the explicit polymorphism provided by our level- and constraint-indexed products. Moreover, our constraint languages differ: their constraints are equalities or (strict) inequalities between level variables, while ours are equalities between level expressions.
