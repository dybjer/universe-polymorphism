...
In the article \cite{coquand:tcs2019} canonicity and normalization are proved for type theory with an external tower of universes. We conjecture that these proofs can be modified to yield proofs of analogous properties (and their corollaries) for our theories with universe level judgments.
