...
in the next sections, a tower universes.
...
To motivate why it may be useful to introduce the notion of judgment relative to a list of constraints on universe levels, consider the following type in a system without cumulativity. (We use Russell style notation for readability, see appendix for the rules for the Russell style version of our system.)
$$
