...
In a forthcoming paper, we plan to present certain generalised algebraic theories of level-indexed categories with families with extra structure.  These give rise to notions of model of our theories with judgments as levels with the following proviso:
...
There is another way to present these initial models, which is by using
