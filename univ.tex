...
We also add identity types $\Idapp{A}{a_0}{a_1}$ for all $A~\type$, 
$a_0:A$ and $a_1:A$, with constructor $\Rfapp{a}$ and (based) eliminator 
$\Japp{A}{a}{C}{d}{x}{p}$, all examples of parametrized syntactic constructs
...
~~~~x:A~~~~p:\Idapp{A}{a}{x}}
{\Japp{A}{a}{C}{d}{x}{p}: C ~~~~~~~~
 \Japp{A}{a}{C}{d}{a}{\Rfapp{a}} = d : C(a/x,\Rfapp{a}/p)}
\belowdisplayshortskip 0pt
$$
\end{figure}
