...
Moreover, we present a type theory with constraints as \emph{judgments} extending Voevodsky's system.
\footnote{PD: Should we replace "extending Voevodsky's system" by "similar to Voevodsky's system"?}
We also add \emph{constraint-indexed products} to this system.
}%endcolor
...
%\footnote{PD: how is this proved?}
...
universe levels and constraints, and this is what we present next.\footnote{What about saying precisely what this refers to and maybe also move the sentence?}
