...
\item We have universe level \emph{judgments}, like Courant~\cite{Courant02}, instead of a \emph{type} of universe levels, like Agda.
 ...
 \item We add the possibility of expressing \emph{explicit} universe level constraints. This is not only more general but also arguably gives a more natural way of expressing types involving universes.
...
We have already discussed both Coq's and Agda's treatment of universe polymorphism in the introduction, including the work of Huet, Harper and Pollack, Courant, Herbelin, and Sozeau and Tabareau. %We will make further remarks on the relationship between our work and the latter below.
...
We already mentioned Sozeau and Tabareau's \cite{SozeauTabareau:coq} work on universe polymorphism in the Coq tradition. However, since their work is closely related to ours, we will discuss the correspondence a bit more.
