...
theory, we can use a type $V$ satisfying the following equality $V =_{\UU_{\beta}} \Sigma_{X:\UU_{\alpha}}X\rightarrow V$.
This equation makes only sense modulo the constraint $\alpha<\beta$.

We can define in our system a constant
$$
c~=~\lam{\alpha~\beta}\lambda_{Y:\UU_{\beta}}~Y =_{\UU_{\beta}} \Sigma_{X:\UU_{\alpha}}X\rightarrow Y~~:~~[\alpha~\beta][\alpha<\beta]\UU_{\beta^+}
$$
