...
{\color{red} Todo: mention that if the semilattice is bounded, that is, has a bottom element, then we get a first universe, but this is not necessary.}

{\color{red} Todo: mention empty semilattice}
