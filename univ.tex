...
and a code for the previous universe, for $n<l$
$${\UU_n^{l}}:\UU_{l}$$
$$\T_{l}({\UU_n^{l}}) = \UU_{n}$$
...
a natural notion of {\em models} of type theory. As explained
...
{\Id~A~a_0~a_1:\UU_n}
$$
and, for $n<l$, we add ${\UU_n}:\UU_{l}$.

\medskip

For the version with cumulativity, we add the rules, for $n<l$
$$
\frac{A:\UU_{n}}{A:\UU_{l}}
$$
