...
These "implicit" approaches to universe polymorphism are, however,
...
This approach is followed in Agda and in Voevodsky's proposal \cite{VV},
{\color{red} albeit in different ways. Whereas Courant uses 
universe level \emph{judgments}, Agda has a \emph{type} of
universe levels (supporting level-indexed products).
Voevodsky proposes type theories parametrized by
