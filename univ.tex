...
we could instead derive the (inhabited) type
$$
...
$$
({\color{red} why is $\psi$ in parenthesis?})
...
$$
   ...
   {\color{red} We need elimination rules for this, and they are more
   involved than in Sec. 4 since one eliminates
   $\lam{\alpha~\beta}\lam{\psi}$ with two level expressions. In general,
   with as many level expressions as there are level variables in $\psi$.}
