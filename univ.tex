...
i.e., a level expression $l$ such  that $l<l$ modulo this set of constraints,
...
Recall that we have, e.g., the following rules in Section~\ref{sec:internal}
$$
...
This is achieved by generalising the rule \ref{fig:leveleq}
from Section~\ref{sec:internal} by the following one.
