...
our universes are \`a la Tarski and we consider both non-cumulative and cumulative versions.
%and called $\UU_m$ with codes $\UU^m_l : \UU_l $ for $l < m$.
%\item
Moreover, they have special rules for introducing universe-monomorphic and universe-polymorphic constants, and a rule for instantiating the latter. We could add similar rules for adding constants, where we would use our level-abstraction when defining universe-polymorphic constants and our level-abstraction when instantiating them.
%\item
