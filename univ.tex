...
%\item
Moreover, they have special rules for introducing universe-monomorphic and universe-polymorphic constants, and a rule for instantiating the latter. We could add similar rules for adding constants, where we would use our level-abstraction when defining universe-polymorphic constants and our level-abstraction for instantiating them.
%\item
