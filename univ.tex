...
such as the ones in \cite{Huet87,moura:lean}, 
there is a need for definitions that are parametric
in universe levels.
...
(rules 29 and 30 in \cite[Sec. 3.4]{VV}).
\item The type theories proposed by Voevodsky in \cite{VV} are parametrized 
...
definitionally equal.\footnote%
{Voevodsky seemingly allows constraints such as $\alpha<\alpha$. 
...
we think this case is better excluded.
}%end footnote
