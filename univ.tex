...
than in an impredicative one, for uniform proofs and modularity.
 It can be shown in particular that the canonical map 
 $\Group(\UU_n)\rightarrow \Group(\UU_{n+1})$ is not an equivalence,
 see \cite{escardo:largegroup}.
...
{\em \`a la Russell} (using the terminology introduced in \cite{martinlof:padova}) of
