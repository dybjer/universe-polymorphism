...
\newcommand{\Idnapp}[4]{\sapp{\Id_#1^#4}{#2,#3}}
...
\begin{figure}[H]
\caption{Rules and conversion rules for codes of $\N$ and $\Id$}\label{fig:NIdU}
$$
...
to stress the fact
that the side-condition $n<l$ is upgraded to a level judgement.}
