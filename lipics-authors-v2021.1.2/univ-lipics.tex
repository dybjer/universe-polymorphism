...
\authorrunning{M. Bezem and T. Coquand and P. Dyber and M. Escard\'o}
 %TODO mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et al.'

\Copyright{Marc Bezem and Thierry Coquand and Peter Dyber and Mart\'{\i}n Escard\'o} %TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
