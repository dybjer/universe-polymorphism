...
\section{Revision and extension} \label{appendix:3}
...
The substitution $\beta/\alpha : (\alpha) \to (\alpha,\beta)$ is allowed,
leading to the example above. The resulting type $[\alpha<\alpha] \NN$
can be considered to be an `empty' product. The substitution
$\beta/\alpha : (\alpha,\alpha<\alpha) \to (\alpha,\beta,\alpha<\beta)$
is not allowed, since $\alpha<\alpha$ is a loop.
...
As an example, if $\sigma$ is the weakening
$(\alpha,\beta,\alpha = \beta)\to (\alpha,\beta)$ and $A$ is a
type in the context $\alpha,\beta,\alpha<\beta$, then $[\alpha < \beta]A$
is a type in the context $\alpha,\beta$
and we add the conversion that $([\alpha<\beta]A)\sigma$ is equal to the
unit type, since $(\alpha<\beta)\sigma = \alpha<\beta$
...
In this solution no explicit substitutions are needed.
