...
do not apply to formulation of type theory with conversion judgements.

The goal of this work is to prove such an equivalence, where type theory is formulated as conversion judgements.
In order to do this, we adopt Streicher's argument presented in \cite{Streicher:semtt}. This argument was
based on basic properties of such a type system (such as subject reduction), that are known to be provable
for systems with a predicative hieararchy of universes \cite{coquand:sophia,abel:neworleans,abel:wroclaw,coq18} and
 There is a natural forgetful map from the Tarski version to the Russell version. Modulo the (known)
