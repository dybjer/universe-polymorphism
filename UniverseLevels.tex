...
\item If we place both of them in one universe, it should be a metatheorem that all types have a unique universe, and otherwise all types should have a minimal universe.
