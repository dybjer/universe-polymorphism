...
This note records discussions between the authors concerning the appropriate setting for univalent mathematics in Martin Löf type theory. For example,  Escard\'o \cite{escardo} has shown how to develop univalent mathematics in the Agda system. However, the Agda system is not a precisely defined logical system, and we would like to present some well-defined systems in which Escard\'o's development can be carried out. We will also present a system similar to Voevodsky's universe polymorphic system \cite{VV}. In this system there are variables ranging over universe levels. algorithm for solving those constraints.
