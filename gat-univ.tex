...
\paragraph{Remark.} Note the similarity with Lawvere's hyperdoctrines \cite{lawvere:hyperdoctrine}. These are contravariant functors (category-indexed families of categories, category-valued presheaves)
