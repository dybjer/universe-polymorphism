...
%(This is not clear: do we need to build a "consistent" sequence of $\T_\Sigma$?) No because all initial objects are isomorphic, and hence we can move between them.
\begin{definition}
