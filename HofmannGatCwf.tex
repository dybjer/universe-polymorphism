...
\begin{description}
\item[Adding a new sort symbol $F$] If $\Gamma \vdash_\Sigma$, then we can introduce a new sort symbol $F$ in the context $\Gamma$ representing the sequence of types of the arguments of $F$.
\begin{itemize}
\item
