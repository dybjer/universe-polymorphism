...
to the inference rules for $\Sigma$. 
\item
$\T_{\Sigma'}$ is based on the same raw syntax as $\T_\Sigma$ but the equivalence relation has changed. It suffices to show that the new equation is satisfied in $\T_{\Sigma'}$ but this is immediate.
\item
