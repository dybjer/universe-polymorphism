...
\item $\T_{([\Obj],[],[])}$ contains the context $(1.\Obj).\Obj[\p_{1,\Obj}]$ (corresponding to the context $x : \Obj, y : \Obj$ in usual notation with variables). Hence we can introduce a new sort $\Hom$ with this context. This sort represents the family $\Hom(x,y)$ of (internal) morphisms.
