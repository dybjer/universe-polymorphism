...
We are writing this note in honour of Martin Hofmann. The introduction of categories with families was strongly influenced by Martin's work on categories with attributes, which for example play the role of "syntax" in his paper on the interpretation of Martin-Löf type theory in locally cartesian closed categories \cite{hofmann:}. Moreover, Martin's lecture notes on "Syntax and Semantics of Dependent Types" are based on cwfs and developed many useful basic results about them, including a conservativity theorem for logical framework encodings using the cwf of presheaves.

Martin made several other very important contributions to the categorical semantics of dependent type theory. His most well-known contribution is probably his work with Thomas Streicher on the groupoid model of dependent type theory. This seminal work was a forerunner to Voevodsky's univalent foundations; their axiom of universe extensionality is a special case of the univalence axiom. 
...
More to write about? Semantical analysis of higher-order abstract syntax
