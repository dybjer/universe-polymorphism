...
n : \Level, \Gamma : \Ctx &\vdash& (\U^n)_\Gamma \in \Tm(\Gamma,(\U_{n+1})_\Gamma)\\
n : \Level, \Gamma : \Ctx, a : \Tm(\Gamma,(\U_n)_\Gamma) &\vdash& \Ta_n^{n+1}(a) : \Tm(\Gamma,(\U_{n+1})_\Gamma)
\end{eqnarray*}
...
\Ta^{n+1}_n((\N^n)_\Gamma) &=& (\N^{n+1})_\Gamma\\
\Ta^{n+1}_n(\Pi^{n}(a,b)) &=& \Pi^{n+1}(\Ta^{n+1}_n(a),\Ta^{n+1}_n(b))\\
\Ta^{n+2}_{n+1}((\U^n)_\Gamma ) &=& (\U^{n+1})_\Gamma
\end{eqnarray*}
