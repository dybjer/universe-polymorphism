...
More generally, Voevodsky \cite{voevodsky:initiality} has outlined a new vision of the theory of syntax and semantics of dependent type theories. In this vision formal systems for dependent type theory are proved to be initial in suitable categories of models. The above mentioned contributions by Streicher and Brunerie are two examples of such characterizations, but Voevodsky's idea is to characterize a whole class of type theories and prove uniform initiality results for the whole class, and let this form the basis for a general metatheory of dependent type theory. Our work can be viewed as a contribution to this programme, since we prove an initiality theorem for an generalized algebraic theory.
