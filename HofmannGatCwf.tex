...
A cwf $\C$ that supports this gat is an {\em internal monoid} in $\C$. This is a cwf-version of the notion of internal monoid which can be defined in any category with finite products. Ordinary (small) monoids come out as internal monoids in $\Set$, the cwf of small sets.
...
\end{eqnarray*}
and the opertor symbols for identity and composition are
