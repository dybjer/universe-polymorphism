...
module MLTT.UniverseStructure where
...
record cumulative-by-coersion (𝓛 : Succ-Sup-Semilattice) : Set₁ where
 ...
 field
  ...
  T-⌜+⌝  : (i j : L) (a : U i) (b : U j)         → T (i ∨ j) (⌜+⌝ i j a b)
                                                 ≣ T i a + T j b

  T-⌜Π⌝  : (i j : L) (a : U i) (b : T i a → U j) → T (i ∨ j) (⌜Π⌝ i j a b)
                                                 ≣ Π (T i a) (λ x → T j (b x))

  T-⌜Σ⌝  : (i j : L) (a : U i) (b : T i a → U j) → T (i ∨ j) (⌜Σ⌝ i j a b)
                                                 ≣ Σ (T i a) (λ x → T j (b x))

  T-⌜W⌝  : (i j : L) (a : U i) (b : T i a → U j) → T (i ∨ j) (⌜W⌝ i j a b)
                                                 ≣ W (T i a) (λ x → T j (b x))

  T-⌜Id⌝ : (i   : L) (a : U i) (x y : T i a)     → T i (⌜Id⌝ i a x y)
                                                 ≣ Id (T i a) x y
